...
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(31, 'Omran'  , 'Shoura'           , 'M', 'V1per'      , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(32, 'Lucas'  , 'Tao Kilmer Larsen', 'M', 'Santorin'   , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(33, 'Tristan', 'Scharge'          , 'M', 'PowerOfEvil', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(34, 'Jason'  , 'Tran'             , 'M', 'WildTurtle' , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(35, 'Lee'    , 'Dong-geun'        , 'M', 'IgNar'      , 2 );

-- Fly Quest Acadmey: Source - https://lol.gamepedia.com/FlyQuest_Academy#Player_Roster
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(36, 'Mohamed', 'Kaddoura', 'M', 'Revenge' , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(37, 'Gabriel', 'Saucier' , 'M', 'Fanatiik', 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(38, 'Stephen', 'Li'      , 'M', 'Triple'  , 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(39, 'Brandon', 'Phan'    , 'M', 'Mash'    , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(40, 'Juan'   , 'Guibert' , 'M', 'JayJ'    , 2 );
...
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(41, 'Jung'   , 'Eon-yeong'     , 'M', 'Impact'    , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(42, 'Mads'   , 'Brock-Pedersen', 'M', 'Broxah'    , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(43, 'Nicolaj', 'Jensen'        , 'M', 'Jensen'    , 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(44, 'Yiliang', 'Peng'          , 'M', 'Doublelift', 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(45, 'Edward' , 'Ra'            , 'M', 'Tactical'  , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(46, 'Jo'     , 'Yong-in'       , 'M', 'CoreJJ'    , 2 );
-- Team Liquid Academy: Source - https://lol.gamepedia.com/Team_Liquid_Academy#Player_Roster
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(47, 'Thomas' , 'Tran'      , 'M', 'Jenkins'  , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(48, 'Shern'  , 'Tai'       , 'M', 'Shernfire', 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(49, 'David'  , 'Bloomquist', 'M', 'Yusui'    , 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(50, 'Richard', 'Samuel Oh' , 'M', 'Rikara'   , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(51, 'Johnson', 'Cao'       , 'M', 'Cao'      , 2 );
...
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(52, 'Kim'    , 'Hyeong-min', 'M', 'Ruin'    , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(53, 'Raymond', 'Griffin'   , 'M', 'Wiggily' , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(54, 'Eugene' , 'Park'      , 'M', 'Pobelter', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(55, 'Trevor' , 'Hayes'     , 'M', 'Stixxay' , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(56, 'Oh'     , 'Myeong-jin', 'M', 'Wind'    , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(57, 'Andy'   , 'Ta'        , 'M', 'Smoothie', 2 );
-- Counter Logic Gaming Academy: Source - https://lol.gamepedia.com/CLG_Academy#Player_Roster
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(58, 'Alexey'        , 'Zatorski', 'M', 'Deus'   , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(59, 'Kristopher'    , 'Myhal'   , 'M', 'Fragas' , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(60, 'Jean-Sébastien', 'Thery'   , 'M', 'Tuesday', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(61, 'Lee'           , 'Hyo-won' , 'M', 'Fill'   , 2 );
...
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(62, 'Heo'     , 'Seung-hoon'  , 'M', 'Huni'    , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(63, 'Matthew' , 'Higginbotham', 'M', 'Akaadian', 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(64, 'Jonathan', 'Armao'       , 'M', 'Grig'    , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(65, 'Henrik'  , 'Hansen'      , 'M', 'Froggen' , 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(66, 'Johnson' , 'Nguyen'      , 'M', 'Johnsun' , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(67, 'Zaqueri' , 'Black'       , 'M', 'Aphromoo', 2 );
-- Dignitas Academy: Source - https://lol.gamepedia.com/Dignitas_Academy#Player_Roster
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(68, 'Samson', 'Jackson' , 'M', 'Lourlo' , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(69, 'Tanner', 'Damonte' , 'M', 'Damonte', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(70, 'Kim'   , 'Jae-hun' , 'M', 'Fenix'  , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(71, 'Kim'   , 'Joo-sung', 'M', 'Olleh'  , 2 );
...
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(72, 'Kevin'  , 'Yarnell' , 'M', 'Hauntzer'  , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(73, 'Can'    , 'Çelik'   , 'M', 'Closer'    , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(74, 'Greyson', 'Gilmer'  , 'M', 'Goldenglue', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(75, 'Victor' , 'Huang'   , 'M', 'FBI'       , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(76, 'Choi'   , 'Jae-hyun', 'M', 'Huhi'      , 2 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(77, 'Yuri'   , 'Jew'     , 'M', 'Keith'     , 2 );
-- Golden Guardian Academy: Source - https://lol.gamepedia.com/Golden_Guardians_Academy#Player_Roster
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(78, 'Darshan' , 'Upadhyaya'     , 'M', 'ZionSpartan', 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(79, 'Anthony' , 'Barkhotsev'    , 'M', 'Hard'       , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(80, 'Nicholas', 'Antonio Abbott', 'M', 'Ablazeolive', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(81, 'Alex'    , 'Gorcia'        , 'M', 'Gorcia'     , 1 );
...
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(82, 'Paul'    , 'Boyer'     , 'M', 'sOAZ'   , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(83, 'Jake'    , 'Puchero'   , 'M', 'Xmithie', 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(84, 'Jérémy'  , 'Valdenaire', 'M', 'Eika'   , 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(85, 'Johnny'  , 'Ru'        , 'M', 'Altec'  , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(86, 'Apollo'  , 'Price'     , 'M', 'Apollo' , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(87, 'Nickolas', 'Surgent'   , 'M', 'Hakuho' , 2 );
-- Immortals Academy: Source - https://lol.gamepedia.com/Immortals_Academy#Player_Roster
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(88, 'Kieran'  , 'Logue'  , 'M', 'Allorim' , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(89, 'Nicholas', 'Pollock', 'M', 'Potluck' , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(90, 'David'   , 'Challe' , 'M', 'Insanity', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(91, 'Austin'  , 'Yu'     , 'M', 'Gate'    , 2 );
...
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(92, 'Sergen' , 'Çelik'   , 'M', 'Broken Blade', 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(93, 'Joshua' , 'Hartnett', 'M', 'Dardoch'     , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(94, 'Søren'  , 'Bjerg'   , 'M', 'Bjergsen'    , 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(95, 'Kasper' , 'Kobberup', 'M', 'Kobbe'       , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(96, 'Vincent', 'Wang'    , 'M', 'Biodaddy'    , 2 );
-- Team Solo Mid Academy: Source - https://lol.gamepedia.com/TSM_Academy#Player_Roster
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(97, 'Niship'   , 'Doshi' , 'M', 'Dhokla' , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(98, 'Mingyi'   , 'Lu'    , 'M', 'Spica'  , 5 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(99, 'Jackson'  , 'Dohan' , 'M', 'Evolved', 3 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(100, 'Lawrence', 'Hui'   , 'M', 'Lost'   , 1 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(101, 'Erik'    , 'Wessén', 'M', 'Treatz' , 2 );
...
-- Add the Substitutes
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(102, 'Colin'   , 'Earnest'  , 'M', 'Solo'    , 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(103, 'Ashkan'  , 'Homayouni', 'M', 'TF Blade', 4 );
INSERT INTO Players (PlayerID, FirstName, LastName, Gender, ProHandle, RoleID ) VALUES(104, 'Rafael'  , 'Knittel'  , 'M', 'Rakin'   , 3 );
